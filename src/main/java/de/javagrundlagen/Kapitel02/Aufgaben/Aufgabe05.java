...
public class Aufgabe05 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(((Object)hexZahl).getClass().getName());
        System.out.println(((Object)hexZahl2).getClass().getName());
        System.out.println(((Object)binZahl).getClass().getName());
        System.out.println(((Object)binZahl2).getClass().getName());
